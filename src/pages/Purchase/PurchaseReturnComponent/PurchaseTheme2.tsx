...
const PurchaseTheme2 = () => {
  ...
  useEffect(() => {
    console.log('Fetching data for invoice_no:', id);
  ...
  const handleEdit = () => {
    navigate(`/edit-purchasereturn/${id}`, { state: { invoiceData } });
  };

  // Update the theme selector styles
    ...
    <div className="bg-white dark:bg-gray-900 p-8">
      ...
      >
        ...
        >
          ...
          <tbody>
            {invoiceData.purchasereturn_items.map((item, index) => (
        ...
        >
          ...
          <p className="w-1/5 text-center">{invoiceData.purchasereturn_items.length}</p>
        ...
        <div className="flex justify-between text-sm mb-4">
          ...
          >
            ...
            {(() => {
              ...
              invoiceData.purchasereturn_items.forEach((item) => {
