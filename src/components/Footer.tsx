      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <a href="/" className="flex items-center mb-4">
              <span className="text-2xl font-bold text-white">Bill<span className="text-billbook-400">Book</span></span>
            </a>
            <p className="text-gray-300 mb-6 max-w-sm">
              An all-in-one business management solution designed for small and medium-sized businesses in India.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 BillBook. All rights reserved.</p>
