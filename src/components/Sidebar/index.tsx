...
import { FaBox, FaUniversity } from 'react-icons/fa';
import { ShoppingBagIcon } from '@heroicons/react/24/solid';
import { FaFileAlt, FaExchangeAlt, FaFileInvoiceDollar } from 'react-icons/fa';
        ...
        {Array.from({ length: 1 }).map((_, index) => (
          <div key={index} className="p-2 ">
            ...
            <div className="flex items-center justify-center p-2 relative">
              ...
              {/* Sidebar Toggle Arrow - Top Right */}
              <button
                ref={trigger}
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
              {/* <!-- Sidebar Menu --> */}
              <nav className="mt-2  px-4 lg:mt-1 lg:px-4">
                {/* <!-- Menu Group --> */}
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/Purchase' || pathname.includes('Sales')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                    ...
                    <li>
                      ...
                      >
                        <MdMoneyOff size={20} className="text-red-500" />
                        Expenses
                      </NavLink>
                    </li>
                    {/* <!-- Menu Item Calendar --> */}
                          ...
                          <React.Fragment>
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                  <NavLink
                                    to="/Reports/Favourite"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                                  >
                                    <MdAutoAwesome size={20} color="gray" />
                                    Favourite
                                  </NavLink>
                                </li>
                                <li>
